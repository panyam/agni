...
![A driver joined to an untyped J1 pin is flagged; the same driver joined to a declared passive R1 pin is fine](images/unspecified-pin-with-driver.svg)
