...
![A declared rail absent, and a rail whose name declares the wrong voltage, are flagged; a rail on its declared nominal is fine](images/voltage-domain-mismatch.svg)
