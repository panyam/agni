...
![A TVS and an LED each carry the diode family tag; a ferrite carries the inductor family tag; each emits one component.class row per tag](images/component.class.svg)
