...
function harness() {
  ...
  const query = { setState: vi.fn(), setRelations: vi.fn(), setExamples: vi.fn(), setLocateNote: vi.fn(), setQuery: vi.fn(), setEntityQueries: vi.fn(), setSelection: vi.fn(), entityQuery: () => "" };
