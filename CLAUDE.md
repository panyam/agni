...
**Four ways to read a design and get a confident WRONG answer.** The first three were hit in one
sitting and are silent. Each returns an empty or partial answer rather than an error, which reads as
