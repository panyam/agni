...
![A ceramic resonator with an external load cap to ground is flagged; a resonator wired with no external caps is fine](images/resonator-redundant-load-caps.svg)
