# Concepts, if you come from hardware
...
If you want the reverse map (circuit ideas explained to a software engineer), that is
[`docs/ANALOGY.md`](../ANALOGY.md). This page and that one are two ends of the same table.
...
- Run these ideas for real: [Getting started](getting-started.md).
- The deep design rationale behind each concept lives in the numbered docs (`docs/13`
  onward). You do not need them to use the tool, but they are there when you want the
  why.
