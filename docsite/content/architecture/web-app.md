...
than a reason to recreate anything. The general rule: a derivation feeding `<For>` is a memo, and the
memo boundary is a correctness concern here rather than a performance one.
