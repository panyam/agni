---
title: "Use it"
description: "Run Agni on a design: checks, diff, query, naming, datasheets."
---
...
- **[Concepts](concepts/)**: the ideas behind the tool, mapped back to bench intuition.
- **[Checks and reports](checks-and-reports/)**: run the rule catalog and read findings.
