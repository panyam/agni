...
![an external net clamped by a Zener is reported (info); the same net with a fast ESD TVS is not flagged]({{.Site.PathPrefix}}/static/images/catalog/rules/esd-clamp-not-tvs.svg)
