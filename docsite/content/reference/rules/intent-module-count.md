...
![A module declared with count 2 but only one present is flagged; two present is fine]({{.Site.PathPrefix}}/static/images/catalog/rules/module-count.svg)
