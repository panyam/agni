---
title: "intent/io-map-pin-mismatch"
description: "A net is not on the pin the design intent's IO map assigns it to."
---

### Remedy

Move the net to the declared pin, or amend the IO map. A pin assignment that moved late and a map nobody updated look identical from here, and the firmware was written against the map.
