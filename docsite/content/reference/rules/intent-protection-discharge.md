---
title: "intent/protection-discharge"
...
![A declared rail with no bleeder is flagged; the same rail with a resistor to ground is fine]({{.Site.PathPrefix}}/static/images/catalog/rules/protection-discharge.svg)
