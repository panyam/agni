...
![Two separate net records both named VCC are flagged; one net named VCC is fine]({{.Site.PathPrefix}}/static/images/catalog/rules/duplicate-net-name.svg)
