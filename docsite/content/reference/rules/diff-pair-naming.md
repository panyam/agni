...
![A positive net with no matching negative half is flagged; a complete P/N pair is fine]({{.Site.PathPrefix}}/static/images/catalog/rules/diff-pair-naming.svg)
