...
![a bus whose members each resolve to a net is fine; one whose members are unresolved is flagged]({{.Site.PathPrefix}}/static/images/catalog/rules/bus-not-modeled.svg)
