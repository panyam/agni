...
![Two rival design-wide rail names on one net are flagged; one shared name is fine]({{.Site.PathPrefix}}/static/images/catalog/rules/power-tap-conflict.svg)
