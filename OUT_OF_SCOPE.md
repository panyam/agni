...
| Only 4 tutorial blocks carry the ```console verify marker; the other ~105 are unchecked. The mechanism and the blocks that had actually drifted shipped together, and marking a rung wholesale means restructuring excerpt-shaped blocks into exact transcripts | issue 217 PR | a rung is next edited for any reason — mark its blocks then, while the output is already being regenerated |
